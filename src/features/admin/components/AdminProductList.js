...
function Pagination({ page, setPage, handlePage, totalItems, totalPages }) {
  return (
            ...
            <div>
              ...
              <div className="mt-5">
                <Link
                  ...
                  className="rounded-md my-5 mt-5 bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-800-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                >
                  Edit Product
                </Link>
              </div>
